...
@Injectable()
export class GetProjectByUserGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const { id } = request.params; // ID del recurso consultado, si aplica
    ...
    try {
      ...
      request.user = {
        isInProject: id === String(payload.sub), // o lógica más compleja
      };
